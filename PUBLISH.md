# Publish metadata — PKG-physics-custom

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-physics-custom` |
| **Registry name** | `physics.custom` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/physics.custom |
